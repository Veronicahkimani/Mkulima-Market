...
<html lang="en">
	<head>
		<meta charset="UTF-8">
		<title><img src=".\images\log.jpg">Mkulima Market</title>
	...
	?>
		...
		<!-- Banner -->
			<section id="banner" class="wrapper">
				<div class="container">
				<h2>Mkulima Market</h2>
				<p>Bringing Fresh Farm Produce Right To Your Doorstep</p>
				<br><br>
				<center>
		...
		<!-- One -->
			<section id="one" class="wrapper style1 align-center">
				<div class="container">
					<header>
						<h2>Mkulima Market</h2>
						<p>Explore the digital ways of trading...</p>
					</header>
					<div class="row 200%">
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">Mkulima Maket &copy; </h3>
		<!--	<div class="logo">
		...
		<div class="footer-center">
			...
			<div>
				...
				<p style="font-size:20px">0711618808</p>
			</div>
			<div>
				<i class="fa fa-envelope"></i>
				<p style="font-size:20px"><a href="mailto:agroculture@gmail.com" style="color:white">verakimani@gmail.com</a></p>
			</div>
		</div>
		...
		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				...
				Mkulima Market is an E-commerce platform that deals with fresh farm Produce. From the farmer direct to the buyer or consumer.
			</p>
			<div class="footer-icons">
				<a  href="#"><i style="margin-left: 0;margin-top:5px;"class="fa fa-facebook"></i></a>
				<a href="#"><i style="margin-left: 0;margin-top:5px" class="fa fa-instagram"></i></a>
				<a href="#"><i style="margin-left: 0;margin-top:5px" class="fa fa-youtube"></i></a>
				<a href="#"><i style="margin-left: 0;margin-top:5px" class="fa fa-twitter"></i></a>
			</div>
		</div>
